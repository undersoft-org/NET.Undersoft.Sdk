...
namespace System.Instant
{
    ...
    public class Figures : IInstant
    {
        ...
        public IRubrics Rubrics { get => sleeve.Rubrics; }

        public int Size { get => sleeve.Size; }
        ...
        private MemberRubrics CloneRubrics()
        {
            ...
            var baseRubrics = (mode == FiguresMode.Sleeve) ? sleeve.Rubrics
                : figure.Rubrics;
            foreach(var rubric in baseRubrics)
            {
                var clonedRubric = new MemberRubric(rubric, true);
        ...
        private IFigures newSleeves(IFigures newsleeves)
        {
            ...
            newsleeves.Linker.Figures = newsleeves;
            return newsleeves;
        }
