/*************************************************
   ...
   System.Series.BaseMassBoard.cs
...
namespace System.Series
{
    ...
    /// <summary>
    /// Defines the <see cref="MassBoardBase{V}" />.
    /// </summary>
    ...
    public abstract class MassBoardBase<V> : MassDeckBase<V> where V : IUnique
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MassBoardBase{V}"/> class.
        /// </summary>
        ...
        public MassBoardBase(IEnumerable<IUnique<V>> collection, int capacity = 17, HashBits bits = HashBits.bit64) : this(capacity, bits)
        {
        ...
        /// <param name="capacity">The capacity<see cref="int"/>.</param>
        /// <param name="bits">The bits<see cref="HashBits"/>.</param>
        public MassBoardBase(IEnumerable<V> collection, int capacity = 17, HashBits bits = HashBits.bit64) : this(capacity, bits)
        {
            foreach (var c in collection)
                this.Add(c);
        }
        ...
        /// <param name="capacity">The capacity<see cref="int"/>.</param>
        /// <param name="bits">The bits<see cref="HashBits"/>.</param>
        public MassBoardBase(IList<IUnique<V>> collection, int capacity = 17, HashBits bits = HashBits.bit64) : this(capacity > collection.Count ? capacity : collection.Count, bits)
        {
            foreach (var c in collection)
                this.Add(c);
        }
        ...
        /// <param name="capacity">The capacity<see cref="int"/>.</param>
        /// <param name="bits">The bits<see cref="HashBits"/>.</param>
        public MassBoardBase(IList<V> collection, int capacity = 17, HashBits bits = HashBits.bit64) : this(capacity > collection.Count ? capacity : collection.Count, bits)
        {
            foreach (var c in collection)
                this.Add(c);
        }
        ...
        /// <param name="capacity">The capacity<see cref="int"/>.</param>
        /// <param name="bits">The bits<see cref="HashBits"/>.</param>
        public MassBoardBase(int capacity = 17, HashBits bits = HashBits.bit64) : base(capacity, bits)
        {
        }
