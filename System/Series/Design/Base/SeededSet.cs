...
using System.Threading;
    ...
    public abstract class SeededSet<V> : Uniqueness, IMassDeck<V> where V : IUnique
    {
        ...
        public bool TryPick(int skip, out ICard<V> output)
        {
            return massDeckImplementation.TryPick(skip, out output);
        }
